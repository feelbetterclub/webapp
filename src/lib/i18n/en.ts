const en = {
  ...
  footer: {
    ...
    colA: { title: "Classes", items: ["Mobility Flow", "Strength Flow", "Pilates Flow", "Dance Burn"] },
    colB: { title: "The Club", items: ["About", "Class Program", "Rituals", "Contact", "Join the Club", "Testimonials"] },
  ...
  moni: {
    ...
    quote: "\"Creating space for others to discover their inner power, connect and grow, is what truly fulfills me.\"",
